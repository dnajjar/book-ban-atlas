...
geojson_path = "./geojson/School_District_Characteristics_-_Current.geojson"
...
output_geojson_path = "./geojson/districts_with_ban_counts_test.geojson"
